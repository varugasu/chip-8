...
@(test)
get_second_nibble_test :: proc(t: ^testing.T) {
	result := chip8.get_second_nibble(0x1234)
	testing.expect_value(t, result, 0x2)
}

@(test)
get_third_nibble_test :: proc(t: ^testing.T) {
	result := chip8.get_third_nibble(0x1234)
	testing.expect_value(t, result, 0x3)
}
